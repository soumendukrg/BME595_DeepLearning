...
class LeNet5(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 6, 5, padding=2)  # use padding 2 to make 28x28 image tensor into 32x32 tensor
...
class img2num:
    def __init__(self):
        ...
        self.learning_rate = 1.0  # learning rate for mini-batch gradient descent
        ...
        load_chkpt_file = 'img2num_model_checkpoint.pth.tar'        # Filename to load checkpoint from
    ...
    def forward(self, img: torch.ByteTensor):
        ...
        Public method: This method takes an image from the MNIST dataset and predict the label of the image using the
        trained LeNet5 neural network model
        ...
        # print(img)
        self.nn_model.eval()  # Sets the module in evaluation mode
        output = self.nn_model(img_4D)  # Forward pass using trained model
